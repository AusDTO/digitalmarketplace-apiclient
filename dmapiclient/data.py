...
class DataAPIClient(BaseAPIClient):
    ...
    def find_suppliers(self, prefix=None, page=None, framework=None, duns_number=None, per_page=None):
        params = {}
        if prefix:
    ...
    def update_supplier(self, supplier_code, supplier, contact=None, user=None):
        supplier_data = dict(supplier)
        if contact is not None:
            supplier_data.update(contacts=[contact])
    ...
    def find_briefs(self, user_id=None, status=None, framework=None, lot=None, page=None, per_page=None, human=None):
        return self._get(
            "/briefs",
